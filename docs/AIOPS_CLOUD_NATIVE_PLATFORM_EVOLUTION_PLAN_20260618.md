...
Backend readiness uses KITE_URL=http://kite:8080, KITE_PUBLIC_URL=http://10.1.132.58:3002, a read-only KITE_DATA_DIR=/app/kite-data mount, and KITE_BACKUP_DIR=/app/backups/kite.
...
Production readiness now checks Kite reachability, Kite sqlite persistence, Kite backup availability, and Kite dry-run restore drills.
```
