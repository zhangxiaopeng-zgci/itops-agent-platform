...
interface EnvConfig {
  ...
  EVOLUTION_RELEASE_CHANGE_WINDOW_ENABLED: boolean;
  EVOLUTION_RELEASE_CHANGE_WINDOW_DAYS: string[];
  EVOLUTION_RELEASE_CHANGE_WINDOW_START: string;
  EVOLUTION_RELEASE_CHANGE_WINDOW_END: string;
  EVOLUTION_RELEASE_CHANGE_WINDOW_TIMEZONE: string;
}
...
function validateEnv(): EnvConfig {
  ...
  return {
    ...
    EVOLUTION_RELEASE_CHANGE_WINDOW_ENABLED: process.env.EVOLUTION_RELEASE_CHANGE_WINDOW_ENABLED !== 'false',
    EVOLUTION_RELEASE_CHANGE_WINDOW_DAYS: getEnv('EVOLUTION_RELEASE_CHANGE_WINDOW_DAYS', '1,2,3,4,5')
      .split(',')
      .map(s => s.trim())
      .filter(Boolean),
    EVOLUTION_RELEASE_CHANGE_WINDOW_START: getEnv('EVOLUTION_RELEASE_CHANGE_WINDOW_START', '09:00'),
    EVOLUTION_RELEASE_CHANGE_WINDOW_END: getEnv('EVOLUTION_RELEASE_CHANGE_WINDOW_END', '18:00'),
    EVOLUTION_RELEASE_CHANGE_WINDOW_TIMEZONE: getEnv('EVOLUTION_RELEASE_CHANGE_WINDOW_TIMEZONE', 'Asia/Shanghai')
  };
}
