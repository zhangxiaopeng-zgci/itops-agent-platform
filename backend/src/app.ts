...
import kubernetesClusterRoutes from './routes/kubernetesClusterRoutes';
import kubernetesCredentialRoutes from './routes/kubernetesCredentialRoutes';
...
import hermesControlPlaneRoutes from './routes/hermesControlPlaneRoutes';
import hermesDashboardRoutes from './routes/hermesDashboardRoutes';
...
import activeInspectionRoutes from './routes/activeInspectionRoutes';
...
app.use('/api/kubernetes-clusters', rateLimiter, kubernetesClusterRoutes);
app.use('/api/kubernetes-credentials', rateLimiter, kubernetesCredentialRoutes);
...
app.use('/api/hermes-control-plane', rateLimiter, hermesControlPlaneRoutes);
app.use('/api/hermes-dashboard', rateLimiter, hermesDashboardRoutes);
...
app.use('/api/active-inspection', rateLimiter, activeInspectionRoutes);
